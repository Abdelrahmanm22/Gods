...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" type="text/css" href="./assets/css/profile - light.css" />
  </head>
  <body>
    <!-- nav start -->
  ...
  <div class="stroke" ><a href="profile.php"><i class="fa-solid fa-circle-half-stroke"></i></a></div>
    ...
    <main>
      <div class="leftContent">
        <div class="user">
          <div class="formImg">
            <img src="./assets/img/profilepic.webp" alt="profile picture" />
          </div>
          <div class="bio">
        ...
        <div class="notificationCont">
          <form action="profile.php">
            ...
            <div class="allow">
              <input
                type="checkbox"
                id="announcementsNotification"
                name="announcementsNotification"
                value="announcementsNotification"
              />
              <label for="announcementsNotification"
                >Announcements for New Events</label
              >
            </div>
            <div class="allow">
              <input
              ...
              />
              <label for="offersNotification"
                >Notification for Exclusive Offers</label
              >
            </div>
            <div class="allow">
              <input
              ...
              />
              <label for="deliveryNotification"
                >Contact You After Delivery</label
              >
            </div>
            <div class="allow">
              <input
                ...
                value="tripNotification"
              />
              <label for="tripNotification"
                >Send Important Reminders About an Upcoming Trip</label
              >
            </div>
