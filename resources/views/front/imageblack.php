    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div><img src="images/osiris-bold.png" class="dropimage"><li><a class="dropdown-item" href="dark3.php">Osiris Myths</a></li></div>
          <div><img src="images/anubis-bold.png" class="dropimage"><li><a class="dropdown-item" href="dark1.php">Anubis</a></li></div>
          <div><img src="images/horus-bold.png" class="dropimage"><li><a class="dropdown-item" href="dark3.php">Horus</a></li></div>
          <div><img src="images/montu-bold.png" class="dropimage"> <li><a class="dropdown-item" href="dark1.php">Montu</a></li></div>
          <div><img src="images/ptah-bold.png" class="dropimage"> <li><a class="dropdown-item" href="dark1.php">Ptah</a></li></div>
          <div><img src="images/ra-bold.png" class="dropimage"><li><a class="dropdown-item" href="dark2.php">Ra</a></li></div>
          <div><img src="images/sekhmet-bold.png" class="dropimage"><li><a class="dropdown-item" href="dark1.css">Sekhmet</a></li></div>
          <div><img src="images/shu-bold.png" class="dropimage"> <li><a class="dropdown-item" href="dark2.php">Shu</a></li></div>
          <div><img src="images/tefnut-bold.png" class="dropimage"> <li><a class="dropdown-item" href="dark2.php">Tefnut</a></li></div>
          </ul>
        </li>
        <li class="nav-item">
...
<!-- End of Navigation bar -->
    ...
    <div class="light_mode">
     ...
     <div class="container">
        <div class="gallery">
                <a href=   'img/ انوبيس.jfif' data-lightbox="my gallery" data-title="Goddess Anubis">
                    <img src=   "img/انوبيس.jfif" alt="" style="margin-left:40px ;" >
                </a> 
                
                <a href='img/montu.jfif' data-lightbox="my gallery" data-title="God Montu">
                    <img src="img/montu.jfif" alt="" style="margin-left: 45px;"    >
                </a>
                
    
                <a href= 'img/بتاح.jfif' data-lightbox="my gallery" data-title="Goddess Ptah">
                    <img src= "img/بتاح.jfif"  alt="" style=" margin-left:40px ;">
                     
                </a>
                
           
            <a href='img/so.jfif' data-lightbox="my gallery" data-title="God Sekhmet  ">
                <img src="img/so.jfif" alt=""style="margin-left: 45px;">
            </a>
           
            
            <a href= 'img/kj.jpg' data-lightbox="my gallery" data-title=" The goddess  Nefertum ">
                <img src= "img/kj.jpg" alt=""style="margin-left:45px ;">
            
            </a>
           
           
            
            <a href= 'img\ اوزرييس.jfif'  data-lightbox="my gallery" data-title="Goddess Osiris.">
                <img src= "img\اوزرييس.jfif" alt=""style=" margin-left:40px">
            </a>
             
            <a href=  'img/rp.jpg' data-lightbox="my gallery" data-title="God Ra ">
                <img src= "img/rp.jpg" alt=""style=" margin-left: 40px;">
            </a>
            
            <a href=  ' img\sh.webp' data-lightbox="my gallery" data-title="Goddess Shu">
                <img src=  "img\sh.webp" alt=""style="margin-left:45px ;">
            </a>  
             
            <a href= 'img\s.png 'data-lightbox="my gallery" data-title="God Tefnut">
                <img src= "img\s.png" alt=""style=" margin-left:45px">
            </a>
            
            <a href= 'img\tu.jpg' data-lightbox="my gallery" data-title="God Tut  ">
                <img src="img\tu.jpg " alt="" style="margin-left: 40px;">
            </a>
            
            <a href=' img\g.jpg' data-lightbox="my gallery" data-title="  God Geb">
                <img src= "img\g.jpg" alt=""style="margin-left:40px ;" >
            </a>
             
            <a href='img\j.jpg' data-lightbox="my gallery" data-title="Goddess Nut ">
                <img src="img\j.jpg" alt=""style="margin-left:45px">
            </a>
            
            <a href= 'img\o.jpg' data-lightbox="my gallery" data-title="God Osiris ">
                <img src= "img\o.jpg" alt=""style="margin-left: 45px;">
            </a>
           
            <a href=  'img\نفتيس.jpg' data-lightbox="my gallery" data-title=" Goddess Neftes">
                <img src=  "img\نفتيس.jpg "alt=""style="margin-left:40px ;" >
          
            
            <a href= 'img\t.jpg' data-lightbox="my gallery" data-title=" God Set">
                <img src= "img\t.jpg" alt=""style="margin-left:40px ;">
            </a>
             
                <a href= 'img\u.jfif' data-lightbox="my gallery" data-title="  God Horus">
            
                 <img src= "img\u.jfif" alt=""style=" margin-left:45px" >
                 </a>
                  
                        <a href= 'img\m.jpg' data-lightbox="my gallery" data-title="  Temple of Montu">
                    
                            <img src= "img\m.jpg" alt=""style=" margin-left:45px" >
                            </a>
                             
                                <a href= 'img\p.jfif' data-lightbox="my gallery" data-title=" Temple of Ptah">
                            
                                    <img src= "img\p.jfif" alt=""style=" margin-left:40px" >
                                    </a>
                                    
                                        <a href= 'img\معبد ايزيس.jpg' data-lightbox="my gallery" data-title="  Temple of Isis">
                                    
                                            <img src= "img\معبد ايزيس.jpg" alt=""style=" margin-left:40px" >
                                            </a>
                                             
                                                <a href= 'img\دندره.jfif' data-lightbox="my gallery" data-title="  Temple of Dundre ">
                                            
                                                    <img src= "img\دندره.jfif" alt=""style=" margin-left:45px" >
                                                    </a>
                                                    
                                                   <a href= 'img/معبد ادفو.jfif' data-lightbox="my gallery" data-title=" Temple of Edfu ">
                                    
                                                    <img src= "img/معبد ادفو.jfif" alt=""style=" margin-left:40px" >
                                                    </a>
