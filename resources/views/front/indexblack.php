...
<head>
    ...
    <link rel="stylesheet" href="indexblack.css">
...
<body style="background-color: rgb(44,43,43);">
    ...
    <div style="background-image: linear-gradient(rgba(0,0,0,0.60),rgba(0,0,0,0.60)),url(images/Heroooo.png);width:100%"  class="backgal">
        ...
        <div class="gallery">
            <img src="images/anubis.jpg" alt="anubis">

        </div>

        <div class="gallery">
            <img src="images/Horuss.jpg" alt="Horus">
        </div>

        <div class="gallery">
            <img src="images/isiss.jpg" alt="isis">
        ...
        <div>
            <div class="gallery1">
                <img src="images/Statues-of-Sekhmet.jpg" alt="Sekhmet">

            </div>
            <div class="gallery1">
                <img src="images/istockphoto-624471686-612x612.jpg" alt="seth">

            </div>
            <div class="gallery1">
                <img src="images/c9bad9155bd0e8f8771da63389d6230c.jpg" alt="ptah">
